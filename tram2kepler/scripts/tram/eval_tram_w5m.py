...
bert = transformers.BertForSequenceClassification.from_pretrained("sentence-transformers/bert-base-wikipedia-sections-mean-tokens").to(device).eval()
tokenizer = transformers.BertTokenizer.from_pretrained("sentence-transformers/bert-base-wikipedia-sections-mean-tokens")
