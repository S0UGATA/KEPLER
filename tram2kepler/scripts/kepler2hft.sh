...
#
# python -m transformers.convert_roberta_original_pytorch_checkpoint_to_pytorch \
# 			--roberta_checkpoint_path /home/sougata/projects/MyKEPLER/tram2kepler/data/checkpoints/convert/single/input/augmented \
# 			--pytorch_dump_folder_path /home/sougata/projects/MyKEPLER/tram2kepler/data/checkpoints/convert/single/output/augmented
#
# python -m transformers.convert_roberta_original_pytorch_checkpoint_to_pytorch \
...
python -m transformers.convert_roberta_original_pytorch_checkpoint_to_pytorch \
			--roberta_checkpoint_path /home/sougata/projects/MyKEPLER/tram2kepler/data/checkpoints/convert/multi/input/augmented \
			--pytorch_dump_folder_path /home/sougata/projects/MyKEPLER/tram2kepler/data/checkpoints/convert/multi/output/augmented